...
public class SysUserController extends BaseController
{
    ...
    public TableDataInfo adminList(SysUser user)
    {
        StringBuilder where = new StringBuilder(
                ...
                " where u.del_flag = '0' and r.del_flag = '0' and r.role_key = 'admin'");
        ...
        {
            where.append(" and u.phonenumber like ?");
        ...
        List<SysUser> rows = jdbcTemplate.query(
                "select distinct u.user_id, u.dept_id, u.user_name, u.nick_name, u.email, u.phonenumber, u.sex, u.status, u.del_flag, u.create_by, u.create_time, u.remark" +
                where + " order by u.user_id asc",
                (rs, rowNum) -> {
                ...
                params.toArray());
        TableDataInfo rspData = new TableDataInfo(rows, rows.size());
