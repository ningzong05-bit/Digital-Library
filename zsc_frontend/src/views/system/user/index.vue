          ...
          <el-col>
            <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
              ...
              <el-form-item label="联系电话" prop="phonenumber">
                <el-input v-model="queryParams.phonenumber" placeholder="请输入联系电话" clearable style="width: 240px" @keyup.enter="handleQuery" />
              </el-form-item>
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="联系电话" align="center" key="phonenumber" prop="phonenumber" v-if="columns.phonenumber.visible" width="120" />
...
const columns = ref({
  ...
  phonenumber: { label: '联系电话', visible: true },
...
const data = reactive({
  ...
  rules: {
    ...
    phonenumber: [{ pattern: /^1[3|4|5|6|7|8|9][0-9]\d{8}$/, message: "请输入正确的联系电话", trigger: "blur" }]
  }
})
